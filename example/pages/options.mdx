...
<OptionTable
  options={[
    ...
    [
        ...
        'Custom string splitter, e.g for typing complex characters, such as those handled by the npm package "grapheme-splitter"',
...
- `splitter` see [here](/examples#custom-splitter)
