import {
  ...
  RemoveCursorExample,
  SplitterByWordExample,
  SplitterComplexCharactersExample
...
<Callout type="info" emoji="💡">
  Note: Typing complex characters like emojis requires a custom [splitter function](#typing-complex-characters). 
</Callout>
...
<Tabs items={["Callback Functions", "useRef Hook", ]}>
